...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:8.0-windows-alpine AS build

COPY . /source

WORKDIR /source/source/WebApi
...
FROM mcr.microsoft.com/dotnet/aspnet:8.0-windows-alpine AS final
WORKDIR /app
