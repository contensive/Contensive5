...
**Related Patterns:** See [Page Widget Pattern](page-widget-pattern.md) and [Dashboard Widget Pattern](dashboard-widget-pattern.md) for complete examples of this approach in practice.
