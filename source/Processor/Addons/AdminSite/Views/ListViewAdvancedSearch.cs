                    ...
                    switch (fieldTypeId[FieldPtr]) {
                        case CPContentBaseClass.FieldTypeIdEnum.Date:
                            ...
                            returnForm = returnForm + "<tr>"
                                ...
                                + "<div style=\"display:block;float:left;width:50px;\">" + HtmlController.inputRadio("FieldMatch" + FieldPtr, ((int)FindWordMatchEnum.MatchEquals).ToString(), FieldMatchOption.ToString(), "") + "=</div>"
