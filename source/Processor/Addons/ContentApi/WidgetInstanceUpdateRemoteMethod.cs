    ...
    public class WidgetInstanceUpdateRemoteMethod : AddonBaseClass {
        ...
        public override object Execute(CPBaseClass cp) {
            try {
                ...
                if (request == null || string.IsNullOrEmpty(request.designBlockTypeGuid) || string.IsNullOrEmpty(request.instanceGuid)) {
                ...
                var addon = DbBaseModel.create<AddonModel>(cp, request.designBlockTypeGuid);
                if (addon == null) {
                ...
                //
                // -- open or create the instance record
