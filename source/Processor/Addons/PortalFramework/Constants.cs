...
namespace Contensive.Processor.Addons.PortalFramework {
    class Constants {
        public static string cr { get; } = Environment.NewLine + "\t";
        ...
        //public const string pathFilenameLayoutAdminUITwoColumnLeft = "BaseAssets\\AdminUITwoColumnLeftLayout.html";
        ////
        ...
        //public const string pathFilenameLayoutAdminUITwoColumnRight = "BaseAssets\\AdminUITwoColumnRightLayout.html";
        //
