    ...
    public class OnInstallClass : Contensive.BaseClasses.AddonBaseClass {
        ...
        public override object Execute(Contensive.BaseClasses.CPBaseClass cp) {
            try {
                ...
                _ = LayoutController.updateLayout(core.cpParent, 0, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetNumberLayoutGuid, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetNumberLayoutName, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetNumberLayoutPathFilename, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetNumberLayoutPathFilename);
                _ = LayoutController.updateLayout(core.cpParent, 0, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetHtmlContentLayoutGuid, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetHtmlContentLayoutName, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetHtmlContentLayoutPathFilename, Contensive.Processor.Addons.WidgetDashboard.Constants.dashboardWidgetHtmlContentLayoutPathFilename);
