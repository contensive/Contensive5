//
// -- moved to design block collection
// -- remvoed from the xml collection file
// -- leave this code here for a while in case it is needed
//
using System;
...
namespace Contensive.Processor.Addons.PageManager {
    /// <summary>
    /// addon interface (xml node removed as this code moved to design blocks)
    /// </summary>
